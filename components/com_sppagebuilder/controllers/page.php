...
class SppagebuilderControllerPage extends FormController
{
	...
	public function exitExitPage()
	{
		...
		try
		{
			...
			{
				$response['response'] = $link . '/index.php?option=com_sppagebuilder&view=dashboard&tmpl=component';
	...
	public function importLayout()
	{
		...
		$apiURL = 'https://www.joomshaper.com/index.php?option=com_layouts&task=template.download&id=' . $id . '&email=' . $email . '&api_key=' . $apiKey;
