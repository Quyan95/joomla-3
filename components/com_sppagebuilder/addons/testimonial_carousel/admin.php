                                ...
                                'fields' => [
                                    'options' => [
                                        ...
                                        'message_margin_bottom' => [
                                            ...
                                            'responsive' => true,
                                            'std' => ['xxl' => 40, 'xl' => 40, 'lg' => 40, 'md' => 40, 'sm' => 40, 'xs' => 40],
                                            'min' => 0,
                                            'max' => 300,
                                        ],
                                        ...
                                        'message_padding' => [
                                            ...
                                            'placeholder' => '10',
                                            'responsive' => true,
                                            'std' => ['xxl' => '30px 30px 30px 30px', 'xl' => '30px 30px 30px 30px', 'lg' => '30px 30px 30px 30px', 'md' => '30px 30px 30px 30px', 'sm' => '25px 25px 25px 25px', 'xs' => '15px 15px 15px 15px'],
                                            'depends' => [['testimonial_carousel_layout', '=', 'testi_layout3']],
                                        ],
                                        ...
                                        'name_margin' => [
                                            ...
                                            'responsive' => true,
                                            'std' => ['xxl' => '10px 0px 0px 0px', 'xl' => '10px 0px 0px 0px', 'lg' => '10px 0px 0px 0px', 'md' => '10px 0px 0px 0px',  'sm' => '10px 0px 0px 0px', 'xs' => '10px 0px 0px 0px'],
                                        ],
                                    ],
                                    ...
                                    'avatar' => [
                                        ...
                                        'avatar_height' => [
                                            ...
                                            'std' => ['xxl' => 60, 'xl' => 60, 'lg' => 60, 'md' => 60, 'sm' => 60, 'xs' => 60],
                                            'responsive' => true,
                                            'min' => 1,
                                            'max' => 200,
                                        ],
                                        ...
                                        'avatar_gap' => [
                                            ...
                                            'std' => ['xxl' => 15, 'xl' => 15, 'lg' => 15, 'md' => 15, 'sm' => 15, 'xs' => 15],
                                            'min' => 0,
                                            'max' => 200,
                                            'responsive' => true,
                                            'depends' => [['testimonial_carousel_layout', '!=', 'testi_layout3']],
                                    ...
                                    'quote' => [
                                        ...
                                        'quote_icon_size' => [
                                            ...
                                            'std' => ['xxl' => 50, 'xl' => 50, 'lg' => 50, 'md' => 50, 'sm' => 50, 'xs' => 50],
                                            'min' => 10,
                                            'max' => 200,
                                            'responsive' => true,
                                            'depends' => [['show_quote_icon', '=', 1]],
                                    ...
                                    'ratings' => [
                                        ...
                                        'rating_size' => [
                                            'type' => 'slider',
                                            'title' => Text::_('COM_SPPAGEBUILDER_GLOBAL_SIZE'),
                                            'std' => ['xxl' => 18, 'xl' => 18, 'lg' => 18, 'md' => 18, 'sm' => 18, 'xs' => 18],
                                            'min' => 0,
                                            'max' => 200,
                                            'responsive' => true,
                                        ],
