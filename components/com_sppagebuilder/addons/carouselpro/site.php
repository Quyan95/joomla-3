...
class SppagebuilderAddonCarouselpro extends SppagebuilderAddons
{
	...
	public static function getTemplate()
	{
		...
		$output .= $lodash->unit('height', '.sppb-carousel-pro .sppb-carousel-control', 'data.arrow_width', 'px', false);
		$output .= $lodash->unit('width', '.sppb-carousel-pro .sppb-carousel-control', 'data.arrow_height', 'px', false);
