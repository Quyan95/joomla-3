        ...
        'attr'       => [
            'general' => [
                ...
                'field_margin' => [
                    ...
                    'responsive' => true,
                    'std'        => ['xxl' => '0px 0px 20px 0px', 'xl' => '0px 0px 15px 0px', 'lg' => '0px 0px 15px 0px', 'md' => '0px 0px 20px 0px', 'sm' => '0px 0px 15px 0px', 'xs' => '0px 0px 15px 0px'],
                ],
                ...
                'fontsize' => [
                    'type'       => 'slider',
                    'title'      => Text::_('COM_SPPAGEBUILDER_GLOBAL_FONT_SIZE'),
                    'std'        => ['xxl' => 16, 'xl' => 16, 'lg' => 16, 'md' => 16, 'sm' => 16, 'xs' => 16],
                    'responsive' => true,
                    'max'        => 400,
                    'depends'    => [
                        ['button_type', '=', 'custom'],
