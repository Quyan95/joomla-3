...
class SppagebuilderAddonModal extends SppagebuilderAddons
{
	...
	public function css()
	{
		...
		if ($modal_selector == 'icon') {
			if ($selector_icon_name) {
				...
				$selectorStyleProps = [
					'selector_icon_border_width' => 'border-width',
				...
				$iconSelectorStyle = $cssHelper->generateStyle('.sppb-modal-selector span', $settings, $selectorStyleProps, $selectorUnits, null, null, false, 'display:inline-block;line-height:1;border-style:solid;');
	...
	public static function getTemplate()
	{
		...
		$output .= $lodash->border('border-color', '.sppb-modal-selector span', 'data.selector_icon_border_color', 'border-style:solid;');
