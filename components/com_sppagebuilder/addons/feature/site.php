...
class SppagebuilderAddonFeature extends SppagebuilderAddons
{
	...
	public function css()
	{
		...
		if ($feature_image_src && ($feature_type === 'image' || $feature_type === 'both')) {
			...
			if (\in_array($title_position, ['left', 'right'])) {
				...
				$css .= $cssHelper->generateStyle('.sppb-img-container', $settings, ['feature_image_width' => 'width'], ['feature_image_width' => '%']);
	...
	public static function getTemplate()
	{
		...
		$output .= $lodash->color('background-color', '&:hover .sppb-addon.sppb-addon-feature', 'data.addon_hover_bg');
