...
class SppagebuilderAddonHeading extends SppagebuilderAddons
{
	...
	public function css()
	{
		...
		$headingTypography = $cssHelper->typography($heading_selector . '.sppb-addon-title', $settings, 'heading_typography', $headingTypographyFallbacks);
		...
		$titleStyle = $cssHelper->generateStyle($heading_selector . '.sppb-addon-title', $settings, $titleProps, $units, $modifiers);
